...
pubmed_csv  = r"C:\Users\axdrx\OneDrive\Escritorio\TFM\Resultados\Resultados b\resultados_pubmed.csv"
scopus_csv  = r"C:\Users\axdrx\OneDrive\Escritorio\TFM\Resultados\Resultados b\resultado_scopus.csv"
...
df = pd.read_csv(r"C:\Users\axdrx\OneDrive\Escritorio\TFM\Resultados\registros_deduplicados.csv", dtype=str)
print("Con abstract:", df["Abstract"].notna().sum())
print("Sin abstract:", df["Abstract"].isna().sum())

resumen = pd.DataFrame({
    "Etapa": [
        "Registros identificados PubMed",
        "Registros identificados Scopus",
        "Total combinado",
        "Duplicados eliminados",
        "Registros únicos tras deduplicación",
        "Registros con abstract",
        "Registros sin abstract"
    ],
    "N": [
        len(pm),
        len(sc),
...
ruta_resumen = os.path.join(output_dir, "resumen_deduplicacion.csv")
